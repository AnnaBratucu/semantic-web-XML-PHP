...
<?php
			...
			echo "<br><br>";
			echo "<h2>These are the persons with the largest number of interests</h2>";
			echo "<br><br>";
			chdir('C:\Users\ANA\Desktop\apache-jena-3.13.1');
			$out = "<pre style='width:600px'>" . htmlspecialchars(shell_exec( 'bat\sparql.bat --data=../SW/project2/project2.rdf --query=../SW/project2/interests.rq' ))."</pre>";
			echo $out;
